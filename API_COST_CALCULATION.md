...
**캐시 전략**: 24시간 TTL (캐시가 만료된 경우에만 업데이트)
...
실제 실행: 캐시 만료 시에만 (24시간마다)
일일 총 비용: 5,050 units (하루 1회만 실행)
```

**월간 사용량**: 5,050 × 30 = **151,500 units**
...
✅ **안전**: 기본 할당량(10,000 units/day) 내에서 안전하게 운영 가능
...
| 항목 | 월간 API 사용량 |
|------|----------------|
| **Search Keyword Updater** | 151,500 units |
